...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/10/15 13:51:39 by mgoliath          #+#    #+#             */
/*   Updated: 2021/10/15 16:58:37 by mgoliath         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*ft_strdup(const char *src)__attribute__((nonnull));
char	*ft_strjoin(const char *s1, const char *s2)__attribute__((nonnull));
